...
- **Confidence score**: 82 | **Source reliability**: B | **Info credibility**: 2
- **Nation-state nexus**: none | **Geopolitical timing**: none
- **Infrastructure generation method**: manual
- **CFPF Phases**: P1-P5
...
- **Related TPs**: TP-0012 (related-to), TP-0037 (related-to), TP-0050 (enhances)
...
- **Fraud types**: `sextortion`, `investment-scam`, `deepfake`, `social-engineering`, `romance-scam`
- **Sectors**: banking, crypto, investment, cross-sector
- **Confidence score**: 78 | **Source reliability**: B | **Info credibility**: 2
- **Nation-state nexus**: none | **Geopolitical timing**: none
- **Infrastructure generation method**: manual
- **CFPF Phases**: P1-P5
...
- **Related TPs**: TP-0011 (related-to), TP-0017 (enhances), TP-0025 (enhances), TP-0026 (enhances)
...
- **Confidence score**: 80 | **Source reliability**: B | **Info credibility**: 2
- **Nation-state nexus**: none | **Geopolitical timing**: none
- **Infrastructure generation method**: manual
- **CFPF Phases**: P1-P5
...
- **Related TPs**: TP-0018 (related-to), TP-0019 (related-to), TP-0029 (related-to)
...
- **Confidence score**: 75 | **Source reliability**: B | **Info credibility**: 2
- **Nation-state nexus**: none | **Geopolitical timing**: none
- **Infrastructure generation method**: ai-assisted
- **CFPF Phases**: P1-P5
...
- **Related TPs**: TP-0043 (enhances), TP-0041 (shares-infrastructure), TP-0042 (shares-infrastructure)
...
- **Confidence score**: 78 | **Source reliability**: B | **Info credibility**: 2
- **Nation-state nexus**: suspected | **Geopolitical timing**: none
- **Infrastructure generation method**: manual
- **CFPF Phases**: P1-P5
...
- **Related TPs**: TP-0044 (enhances), TP-0045 (related-to), TP-0049 (shares-infrastructure)
...
- **Sectors**: insurance, healthcare, banking, government
- **Confidence score**: 72 | **Source reliability**: C | **Info credibility**: 3
- **Nation-state nexus**: none | **Geopolitical timing**: none
- **Infrastructure generation method**: manual
- **CFPF Phases**: P1-P5
...
- **Related TPs**: TP-0005 (related-to), TP-0010 (related-to), TP-0018 (related-to), TP-0028 (related-to)
...
`insurance-fraud` already exists in taxonomy. Net change: 77 -> 81 fraud types.

> **Note**: All sector names use lowercase in YAML frontmatter (e.g., `banking`, not `Banking`).
...
4. Run database rebuild (`scripts/build_database.py`) — this auto-regenerates `ThreatPaths/INDEX.md`, all JSON APIs, SQLite, search index, and stats
5. Verify generated artifacts (API endpoints, stats, search index, INDEX.md)

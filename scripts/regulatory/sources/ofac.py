...
class OFACSource(RegulatorySource):
    ...
    _PROGRAM_CATEGORY_MAP = {
        ...
        "IRAN-EO13846": "sanctions-evasion",
        ...
        "RUSSIA-EO14071": "sanctions-evasion",
        "CUBA": "sanctions-evasion",
        "DPRK": "sanctions-evasion",
        "DPRK-EO13810": "sanctions-evasion",
        "VENEZUELA": "sanctions-evasion",
        "GLOMAG": "sanctions-evasion",
        "IFSR": "sanctions-evasion",
        "HRIT-SY": "sanctions-evasion",
        "SDNTK": "terrorism-financing",
